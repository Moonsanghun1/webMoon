...
public class AlbumReplyDeleteService implements Service {
	...
	public Integer service(Object obj) throws Exception {
		...
		// BoardReplyController - (Execute) - [BoardReplyDeleteService] - [BoardDAO.delete()]
		return dao.delete((AlbumReplyVO)obj);
