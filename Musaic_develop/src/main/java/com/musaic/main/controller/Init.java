...
import com.musaic.cartalbum.service.CartAlbumPayClickService;
	...
	static {
		...
		// ---- [이벤트 댓글 객체 생성과 조립 ] -----------------------
	      ...
	      //---------[앨범 장바구니 생성 및 조립]-------------------
				...
				serviceMap.put("/cartalbum/payclick.do", new CartAlbumPayClickService());
				...
				serviceMap.get("/cartalbum/payclick.do").setDAO(daoMap.get("cartalbumDAO"));
