...
public class CartAlbumWriteService implements Service {
	...
	public Integer service(Object obj) throws Exception {
		...
		// CartAlbumController - (Execute) - [CartAlbumWriteService] - CartAlbumDAO.write()
		return dao.write((CartAlbumVO)obj);
	}
