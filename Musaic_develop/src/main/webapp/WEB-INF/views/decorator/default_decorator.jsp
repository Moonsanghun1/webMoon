                ...
                <c:if test="${ !empty login }">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="/cart/list.do"><i class="fa fa-shopping-cart"></i> Cart</a>
                            <a class="dropdown-item" href="/pay/payView.do"><i class="material-icons" style="font-size:20px">payment</i> Pay </a>
