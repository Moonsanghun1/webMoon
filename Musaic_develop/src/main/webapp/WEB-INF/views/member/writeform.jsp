	...
	<div class="container">
		...
		<form action="write.do" method="post">
		    ...
		    <div id="checkname" class="text-secondary">
				<i class="fa fa-check"></i> 2자~30자의 한글 이름을 입력하시오.
			</div>
		    <hr>
		    <div class="form-group">
		    ...
		    <div class="form-group" id="addressdiv">
			  ...
			  <input class="form-control" name="address" id="sample6_address" placeholder="주소"><br>
			  <input class="form-control" name="address" id="sample6_detailAddress" placeholder="상세주소">
