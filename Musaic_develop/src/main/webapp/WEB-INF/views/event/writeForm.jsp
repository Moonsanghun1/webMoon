...
<div class="container">
    ...
    <form action="write.do" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="startDate">게시일</label> <input id="startDate"
                name="startDate" required autocomplete="off"
                class="form-control datetimepicker">
        </div>
        <div class="form-group">
            <label for="endDate">종료일</label> <input id="endDate" name="endDate"
                required autocomplete="off" class="form-control datetimepicker">
        </div>
        
        <div class="form-group">
            <label for="anocDate">발표일</label> <input id="anocDate" name="anocDate"
