...
$(document).ready(function() {
 ...
 // 플레이리스트의 곡 정보를 tracks 배열에 저장
    ...
    $(".deletebtn").click(function() {
        let selectedSongs = $("input[name='musicno']:checked").map(function() {
        ...
        if (selectedSongs.length === 0) {
            ...
            let selectedMusicNos = $("input[name='musicno']:checked").map(function() {
                return $(this).val();
            }).get().join(",");
            $("input[name='musicno_hidden']").val(selectedMusicNos);
                        ...
                        <c:forEach items="${list}" var="vo">
                            <div class="dataRow" data-musicno="${vo.musicNo}" data-musicfile="${vo.musicFile}">
                                <div class="card" style="width: 100%">
                                    ...
                                    <div class="card-body">
                                        <input type="checkbox" name="musicno" value="${vo.musicNo}" class="form-check-input">
