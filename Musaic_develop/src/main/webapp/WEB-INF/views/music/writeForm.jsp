...
<body>
	<div class="container mt-5">
		<h1>Music WriteForm</h1>
		<form action="write.do" method="post" id="writeForm"
			enctype="multipart/form-data">
			<input name="perPageNum" value="${param.perPageNum}" type="hidden">
			<input name="albumNO" value="${param.albumNO}" type="hidden">
					...
					<div class="form-group-container mt-5">
						<div class="form-group">
							<label for="musicTitle" class="label"> 음원명 <span
								...
								type="text" class="form-control" placeholder="제목 입력"
						...
						<!-- 앨범 선택 드롭다운 -->
						<div>
							<label for="albumNo"></label> 앨범 선택<span
								class="badge badge-secondary badge-spacing">필수</span><select name="albumNo"
								class="custom-select mb-3">
								<option selected>앨범 선택</option>
						...
						<div class="form-group">
							<label for="includedNo" class="label"> 수록곡 번호(max 100)
							<span class="badge badge-secondary badge-spacing">필수</span></label>
							<input class="form-control" id="includedNo" name="includedNo" type="number" max="100" required>
						</div>
					</div>
				</div>
				<div class="form-column">
