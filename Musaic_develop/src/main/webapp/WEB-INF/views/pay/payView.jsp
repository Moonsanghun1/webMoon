...
<body>
	<div class="container">
		...
		<div>
		<b class="albumPont">${vo.price }원</b>
		</div>
		</div>
		</div>
		</c:forEach>
		 ...
		 <div class="alert alert-primary">
  		 	<strong>총 가격:</strong>${cart.get(0).cartPrice }원 
  		</div>
		...
		<div class=row>
			...
			<span class="payMeans">계좌번호: ${vo.bankNum }</span>
	      	...
	      	<span class="float-right"><b>${cart.get(0).cartPrice }원</b></span>
	      	</span><br>
	      	<span class="flexSpan">할인 금액
	      	<span class="float-right"><b>0원</b></span>
	      	</span><br>
	      	<span class="flexSpan">배송지
	      	<span class="float-right"><b>0원</b></span>
	      	</span>
		...
		<div class="horizontal-line"></div> <!-- 얇은 선  -->
		 <div class="alert alert-primary addSum">
  		 	<strong>총 결제금액:</strong>${cart.get(0).cartPrice }원 
  		</div>
		</div>	
		<!-- 클릭하면 메인으로 간다. -->
