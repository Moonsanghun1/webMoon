...
<body>
	...
	<form action="payWrite.do" method="post">
		...
		<c:forEach items="${list}" var="vo">
		   ...
		   <div class="text-container">
		       <i>${vo.cartTitle }</i> 수량: ${vo.albumCnt }개
		       <div>
		           <b class="albumPont cartSum">${vo.price }</b>원
		       </div>
		   </div><br>
		   <div class="marginLine"></div>
		</c:forEach>
		 <div class="alert alert-primary">
  		 	<strong id="totalSum">총 가격:</strong>${list.get(0).cartPrice } 
  		</div>
		</div>
	<!-- 서로 간격을 주기 위해 사용 -->
	<div class="marginLine"></div>
	...
	<div class="marginLine"></div>	
		...
		<div class="cards"> <!-- 나중에 hide으로 숨기기 위해서 div로 감싸줌  -->
			...
			<div class="form-group">
			  ...
			  <input type="text" class="form-control" id="cardNum" name="cardNum" placeholder="신용카드 번호를 입력해주세요.">
			</div>	<!-- 신용카드 번호 입력 끝 -->
			</div> <!-- 신용카드 끝 -->
	<!-- 휴대폰 결제 시작 -->
		<div class="phones">
		    ...
		    <div class="form-group">
		        ...
		        <input type="text" class="form-control" id="payTel" name="payTel" placeholder="전화번호를 입력해주세요.">
		    </div>
		</div>
	<!-- 휴대폰 결제 끝 -->
	<!-- 계좌번호 결제 시작 -->
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="bankNum" name="bankNum" placeholder="계좌번호를 입력해주세요.">
    </div>
	</div>	
	<!-- 계좌번호 결제 끝 -->
	</div>
