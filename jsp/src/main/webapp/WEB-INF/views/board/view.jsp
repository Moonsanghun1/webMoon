...
<body>
	<div class="container">
<h1><i class="fa fa-align-justify" style="font-size:24px"></i></h1>
		...
		<table class="table">
			...
			<tr>
				...
				<td colspan='2'><a href="updateForm.jsp"
					class="btn btn-primary">수정</a> <!-- <button class="btn btn-danger" id="deleteBtn">삭제</button>-->
					<button type="button" class="btn btn-danger" data-toggle="modal"
						data-target="#deleteModal" id = "deleteBtn">삭제</button> 
						<a href="list.jsp" class="btn btn-success">리스트</a>
					<!-- 					<div id="deleteDiv"> -->
					<!-- 						<form action="delete.jsp" method="post" id="deleteForm"> -->
					<!-- 							<input type="hidden" name="no" value="10"> <input --> <!-- 								name="pw" required pattern="^.{3,20}&" type="password" -->
					<!-- 								title="비밀번호는 3~20자로 작성하셔야 합니다." placeholder="본인 확인용 비밀번호 확인" -->
					<!-- 								maxlength="20"> --> <!-- 							<button class="btn btn-danger">삭제</button> -->
					<!-- 							<button type="button" class="btn btn-success" --> <!-- 								id="deleteCancelBtn">취소</button> -->
					<!-- 						</form> --> <!-- 					</div> --></td>
			</tr>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
						...
						<form action="delete.jsp" method="post" id= "deleteForm">
							...
							<input
								name="pw" required pattern="^.{3,20}&" type="password" id="pw"
								title="비밀번호는 3~20자로 작성하셔야 합니다." placeholder="본인 확인용 비밀번호 확인"
								maxlength="20">
